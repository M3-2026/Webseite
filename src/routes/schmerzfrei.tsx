          ...
          <div className="mb-20 grid lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-xl md:text-2xl text-gold font-medium leading-relaxed max-w-2xl">
                Bewegung mit Vertrauen: Schmerzfrei & Beweglich.
              </p>
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-2xl whitespace-pre-line">
                Chronische Verspannungen, Rückenschmerzen oder Gelenkprobleme verändern den gesamten Alltag.
                {"\n\n"}
                Gemeinsam identifizieren wir muskuläre Dysbalancen, korrigieren fehlerhafte Bewegungsmuster und bringen deinen Körper Schritt für Schritt zurück in schmerzfreie Stabilität und Funktion.
              </p>
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative w-full max-w-md rounded-3xl overflow-hidden border-2 border-gold/40 shadow-[var(--shadow-gold)] bg-black group aspect-square">
                <img
                  src="/images/performance/card-schmerzfrei.png"
                  alt="M³ Schmerzfrei – Schmerzfrei & Beweglich"
