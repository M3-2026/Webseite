          ...
          <div className="mb-20 grid lg:grid-cols-12 gap-8 lg:gap-10 xl:gap-12 items-center">
            <div className="lg:col-span-7 space-y-5 sm:space-y-6 min-w-0">
              ...
              <p className="text-sm sm:text-base md:text-lg text-muted-foreground leading-relaxed max-w-2xl whitespace-pre-line">
                ...
                {"\n\n"}
                Sie bedeutet, die richtigen Entscheidungen für deinen Stoffwechsel, deinen fordernden Alltag und deine persönlichen Ziele zu treffen. Gemeinsam entwickeln wir ein Ernährungskonzept, das dich stärkt und dauerhaft funktioniert.
              </p>
              ...
              <div className="relative w-full max-w-[380px] sm:max-w-md rounded-3xl overflow-hidden border border-orange-500/30 bg-card/80 shadow-2xl group aspect-square">
                ...
                <div className="absolute bottom-4 left-4 right-4 p-3 rounded-2xl bg-black/60 backdrop-blur-md border border-white/15 text-white shadow-xl flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <div className="w-8 h-8 rounded-xl bg-orange-500/20 border border-orange-500/30 text-orange-400 flex items-center justify-center text-sm font-bold shrink-0">
                      🥗
                    </div>
                    <div>
                      <div className="text-xs font-bold tracking-tight text-white">Makro-Struktur</div>
                      <div className="text-[10px] text-slate-300">Ohne Diät-Korsett & Jojo-Effekt</div>
                    </div>
                  </div>
                  <span className="text-[9px] font-mono uppercase tracking-wider text-orange-400 font-bold px-2 py-0.5 rounded-md bg-orange-500/20 border border-orange-500/30">
                    1:1 Betreuung
                  </span>
                </div>
              </div>
