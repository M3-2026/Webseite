        ...
        <div className="relative max-w-5xl mx-auto px-6">
          ...
          <div className="mb-24">
            ...
            <p className="text-xl md:text-2xl text-gold font-medium leading-relaxed max-w-3xl mb-6">
              Ernährung, die zu deinem Leben passt.
            </p>
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-3xl mb-12 whitespace-pre-line">
              ...
              {"\n\n"}
              Sie bedeutet, die richtigen Entscheidungen für deinen Körper, deinen Alltag und deine persönlichen Ziele zu treffen.
              {"\n\n"}
              Gemeinsam entwickeln wir eine Ernährungsstrategie, die langfristig funktioniert.
            </p>
