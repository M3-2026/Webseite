...
export const SEARCH_DIRECTORY: SearchEntry[] = [
  ...
  },
  {
    ...
    category: "Offers",
    pillar: "gold",
    keywords: ["reset", "darm", "stoffwechsel", "kur", "flaggschiff", "reinigung", "energie", "m1"],
    icon: Sparkles,
  },
  {
    title: "M¹ Metabolism",
  ...
  },
  {
    ...
    category: "Offers",
    pillar: "m1",
    keywords: ["ernährung", "coaching", "makros", "diät", "kalorien", "essen", "kochen", "plan", "m1"],
    icon: Flame,
  },
  {
    ...
    category: "Offers",
    pillar: "m1",
    keywords: ["darm", "begleitung", "mikrobiom", "blähbauch", "stoffwechsel", "verdauung", "m1"],
    icon: Activity,
  },
  {
    ...
    category: "Offers",
    pillar: "m1",
    keywords: ["grundversorgung", "vitamine", "mineralien", "nährstoffe", "supplemente", "gold", "m1"],
    icon: Sparkles,
  },
  {
    title: "M² Movement",
  ...
  },
  {
    ...
    category: "Offers",
    pillar: "m2",
    keywords: ["schmerz", "schmerzfrei", "rücken", "nacken", "gelenke", "reha", "physio", "haltung", "m2"],
    icon: Dumbbell,
  },
  {
    ...
    category: "Offers",
    pillar: "m2",
    keywords: ["performance", "training", "personal training", "kraft", "athletik", "muskelaufbau", "m2"],
    icon: Dumbbell,
  },
  {
    ...
    category: "Offers",
    pillar: "m2",
    keywords: ["zwei", "partner", "paare", "freunde", "duo", "training", "m2"],
    icon: HeartHandshake,
  },
  {
